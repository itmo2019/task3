...
function createLogo() {
    ...
    logo.className = "mail__item mail__logo";
...
function createTitle(id) {
    ...
    title.className = "mail__item mail__title text_hide-by-size";
...
function createMessage() {
    ...
    message.className = "mail__item mail__text-message text_hide-by-size";
...
function createDate() {
    ...
    time.className = "mail__item mail__receive-time text_hide-by-size";
